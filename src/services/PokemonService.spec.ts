...
describe("Test service PokemonService", () => {
  test("Comprobar si se realizó una lista de obtención get list para url correcta", async () => {
  ...
  test("Verifica si se obtiene id de url", async () => {
